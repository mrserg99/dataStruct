...
public class SetCircleList {
    ...
    public SetCircleList intersection(SetCircleList b) {
        //Создаём новое множество С, в которое запишем результат,
        //Проверим:
    ...
    public SetCircleList difference(SetCircleList b) {
        //Создаём новое множество С, в которое запишем результат,
        //Проверим:
    ...
    public SetCircleList assign(SetCircleList b) {
        ...
        SetCircleList C = new SetCircleList(b);
        tail = C.tail;
        return C;
    }
    ...
    public SetCircleList find(SetCircleList b, int x) {
        ...
        Если есть, то возвращаем множество В*/
            if (b.tail != null
                    && b.search(b.tail.next, new Atom(x)).next.value == x)
                return b;
