...
public class SetLinkedList implements MySet {
    ...
    public MySet union(MySet b) {
        ...
        if (this.head == null && ((SetLinkedList)b).head == null) {
        ...
        else if (((SetLinkedList)b).head == null) {
        ...
        C.head = this.head.union(this.head, ((SetLinkedList)b).head);
    ...
    public MySet intersection(MySet b) {
        ...
        if (this.head == null || ((SetLinkedList)b).head == null) return new SetLinkedList();
        //Если this == B, то есть ссылки указывают на один и тот же объект,
        //значит мы передали два одинаковых множества(this = B),
        //для множества this вызовем копирующий конструктор и присвоим результат в С
        ...
        SetLinkedList C = new SetLinkedList();
        C.head = this.head.intersection(this.head, ((SetLinkedList)b).head);
    ...
    public MySet merge(MySet b) {
        ...
        if (this.head == null) return new SetLinkedList(((SetLinkedList)b));
        ...
        SetLinkedList C = new SetLinkedList();
        C.head = this.head.merge(this.head, ((SetLinkedList)b).head);
        if (C.head == null){
            return null;
        } else {
            //Возвращаем С
    ...
    public MySet assign(MySet b) {
        ...
        if (this == ((SetLinkedList)b)) return this;


        //Далее в this.head присвоим значение B.head.copy(B.head)
        this.head = ((SetLinkedList)b).head.copy(((SetLinkedList)b).head);
        return this;
    }
    ...
    public boolean equal(MySet b) {
        ...
        if (this.head == null && ((SetLinkedList)b).head == null) return true;
        //Если множество this или В пустые, то мы возвращаем true
        if (this.head == null || ((SetLinkedList)b).head == null) return false;
        //Если первые элементы множеств отличаются, то возвращаем false
        if (this.head.value != ((SetLinkedList)b).head.value) return false;
        /*Если this == B, то есть ссылки указывают на один и тот же объект,
          значит мы передали два одинаковых множества(this = A и B = A). Возвращаем true*/
        if (this == ((SetLinkedList)b)) return true;
        ...
        Atom itemB = ((SetLinkedList)b).head;
    ...
    public MySet find(MySet b, int x) {
        ...
        if (this.head == null && ((SetLinkedList)b).head == null) return null;
        ...
        if (((SetLinkedList)b).head != null) {
            if (((SetLinkedList)b).head.value == x) return ((SetLinkedList)b);
            Atom isFind = search(((SetLinkedList)b).head, x);
            //если есть, то возвращаем множество this
            if (isFind.next.value == x) return ((SetLinkedList)b);
        }
